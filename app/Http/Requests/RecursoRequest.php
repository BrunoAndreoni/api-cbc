...
class RecursoRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'valor_consumo.required' => 'O campo valor_consumo é obrigatório.',
            'valor_consumo.string' => 'O campo valor_consumo deve ser uma string.',
            'valor_consumo.max' => 'O campo valor_consumo não pode ter mais de 255 caracteres.',
        ];
    }
